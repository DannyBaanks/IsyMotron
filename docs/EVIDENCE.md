...
| **C** — Doctor detects an undeclared side effect and blocks promotion | `NOT_DEMONSTRATED` | Doctor V0 compares sealed observation traces; no sandbox/provider supplies a real activity trace yet. |

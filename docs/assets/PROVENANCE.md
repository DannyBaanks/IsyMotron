...
| Asset | Origin | Use | Evidence / license |
|---|---|---|---|
| `hero.png` | Generated artwork | README concept hero only | Built-in image generation; illustrative, not product evidence; 2026-09-21 |
...
used to claim that a UI state, benchmark or hardware run occurred.

...
- L3 A/C/D and memory — oracle internals (COMPOSABLE, NOT_DEMONSTRATED)
- L4 crazy operation — oracle `op` + opcode 62 (COMPOSABLE, NOT_DEMONSTRATED)
- L5 self-modification — oracle encrypt-after-execute (COMPOSABLE, NOT_DEMONSTRATED)
- L6 small executable programs — codec.assemble + oracle run (COMPOSABLE, NOT_DEMONSTRATED)
